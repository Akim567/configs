...
[_QWERTY] = LAYOUT(
  ...
  MT(MOD_LCTL, KC_RBRC),   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                              KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_LBRC,
  MT(MOD_LGUI, KC_GRV),   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                               KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  MT(MOD_LGUI, KC_QUOT),
